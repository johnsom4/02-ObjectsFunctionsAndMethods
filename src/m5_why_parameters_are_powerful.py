...
def main():
    ...
    # better_draw_circles(rg.Point(100, 50), 7)
    # better_draw_circles(rg.Point(-200, 0), 14)
    # even_better_draw_circles(rg.Point(100, 50), 6, 17, 'blue', 2)
    # even_better_draw_circles(rg.Point(-200, 0), 8, 28, 'magenta', 5)
    even_better_draw_circles(rg.Point(350, -150), 6, 3, 'yellow', 5)
    even_better_draw_circles(rg.Point(320, 3), 12, 6, 'black', 4)
    even_better_draw_circles(rg.Point(54, -24), 7, 43, 'maroon', 6)
    even_better_draw_circles(rg.Point(-23, 34), 9, 13, 'red', 3)
    even_better_draw_circles(rg.Point(-156, -6), 25, 20, 'magenta', 2)
    even_better_draw_circles(rg.Point(-356, 34), 4, 32, 'blue', 1)
    window.update()
...
def even_better_draw_circles(point, radii, circles, circlecolor, thickness):
    ...
    turtle = rg.SimpleTurtle()
    turtle.pen = rg.Pen(circlecolor, thickness)
    turtle.pen_up()
    turtle.go_to(point)
    turtle.set_heading(0)  # Point "east" (towards the right)

    for k in range(0, circles):  # k becomes 1, 2, 3, ... 10
