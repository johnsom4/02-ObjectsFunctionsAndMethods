...
def try_methods():
    captain = rg.SimpleTurtle()
    captain.pen = rg.Pen("brown", 5)
    captain.forward(150)
    captain.left(90)
    captain.forward(50)
    captain.backward(100)
...
def try_methods_and_functions():
    ...
    dan.backward(150)
    dan.speed = 1
    draw_many_squares(dan, 2, 100, 30)
    dan.speed = 5
    dan.pen.color = "red"
    draw_many_squares(dan, 10, 50, 15)
    dan.speed = 100
    dan.pen.thickness = 35
    draw_many_squares(dan, 8, 300, 60)
